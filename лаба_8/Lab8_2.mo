model Lab8_2
  parameter Real M0_1 = 3.9; // Начальное x1
  parameter Real M0_2 = 3; // Начальное x2
  parameter Real p_cr = 9.9; // Критическая стоимость продукта
  parameter Real tau1 = 12; // Длительность производственного цикла 1 фирмы
  parameter Real tau2 = 18; // Длительность производственного цикла 2 фирмы
  parameter Real p1= 6; // Себестоимость продукта фирмы 1
  parameter Real p2 = 4; // Себестоимость продукта фирмы 2
...
equation
  der(x1) = (c1/c1) * x1 - (b/c1 + 0.0012) * x1 * x2 - (a1/c1) * x1 * x1;
